      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
          ...
          <div className="flex flex-row gap-6 justify-center mb-6">
            <div
              className="flex flex-1 min-w-[200px] max-w-[260px] cursor-pointer items-center gap-4 bg-gray-50 px-4 min-h-[72px] py-4 rounded-xl border transition-all duration-200 border-transparent"
              onClick={() => router.push("/hobbies/1/academics")}
            >
            ...
            <div
              className="flex flex-1 min-w-[200px] max-w-[260px] cursor-pointer items-center gap-4 bg-gray-50 px-4 min-h-[72px] py-4 rounded-xl border transition-all duration-200 border-transparent"
              onClick={() => router.push("/hobbies/1/hobby-zone")}
            >
              <div className="text-[#101518] flex items-center justify-center rounded-lg bg-[#eaedf1] shrink-0 size-12">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <div
              className="flex flex-1 min-w-[200px] max-w-[260px] cursor-pointer items-center gap-4 bg-gray-50 px-4 min-h-[72px] py-4 rounded-xl border transition-all duration-200 border-transparent"
              onClick={() => router.push("/hobbies/1/story-mode")}
            >
              <div className="text-[#101518] flex items-center justify-center rounded-lg bg-[#eaedf1] shrink-0 size-12">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
